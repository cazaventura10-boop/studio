  ...
  <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
    ...
    <div>
      ...
      <div className="flex gap-4">
        ...
        <a href="https://www.instagram.com/deporeyaventura.es" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-3 rounded-full hover:bg-orange-600 hover:text-white transition"><Instagram size={20} /></a>
