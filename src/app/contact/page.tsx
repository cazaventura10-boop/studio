  ...
  return (
    <div className="bg-secondary">
        ...
        <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-extrabold font-headline tracking-tight">Get In Touch</h1>
            ...
            <div className="space-y-8 flex flex-col justify-center">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">123 Adventure Lane, Mountain View, CA 94043</p>
                    </div>
                </div>
                <div className="flex items-start gap-4">
                    <div className="bg-primary text-primary-foreground p-3 rounded-md flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">hello@deporteyaventura.es</p>
                    </div>
                </div>
                <div className="flex items-start gap-4">
                    <div className="bg-primary text-primary-foreground p-3 rounded-md flex-shrink-0">
