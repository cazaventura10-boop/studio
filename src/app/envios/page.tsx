      ...
      <div className="space-y-10">
        ...
        <section>
          ...
          <p className="mb-6 leading-relaxed">
            Deporteyaventura garantiza la entrega al transportista el mismo día de la realización del pedido para todos aquellos que se formalicen antes de las <strong>11:00 horas (L-V)</strong>, siempre que se encuentren en stock. Los pedidos realizados en sábados, domingos o festivos se tramitarán el siguiente día laborable.
          </p>
          <p className="mb-6 text-sm text-muted-foreground">
            Los plazos se computan en días hábiles y pueden verse alterados por fiestas locales o nacionales. Si la forma de pago es transferencia bancaria, el envío se realizará tras la confirmación bancaria.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="border-2 border-gray-100 p-6 rounded-2xl hover:border-orange-200 transition bg-gray-50">
              ...
              <ul className="text-sm space-y-2">
                ...
                <li className="flex justify-between"><span>Entrega estimada:</span> <strong>1-3 días laborables</strong></li>
              </ul>
            </div>
            {/* BALEARES */}
            <div className="border-2 border-gray-100 p-6 rounded-2xl hover:border-orange-200 transition bg-gray-50">
          ...
          <p className="text-xs text-gray-500 mt-4 italic">* No realizamos envíos a apartados postales. Para otros destinos, consultar en <a href="mailto:comercio@deporteyaventura.es" class="font-semibold text-primary hover:underline">comercio@deporteyaventura.es</a>.</p>
        </section>
